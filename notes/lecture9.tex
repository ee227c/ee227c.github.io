...
The theorem is originally from \cite{nemirovskii1983problem}, but the presentation in
...
%%%%%%%%%%%% TODO: Vlad %%%%%%%%%%%%%%%%%%%%%%
% ADD a code example showing when AGD fails
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
First, we define the notion of an inexact gradient oracle. Recall for a
