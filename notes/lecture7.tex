...
This lemma was initially proven by Allen-Zhu and Orecchia in 2014 in their article \textit{Linear Coupling: An Ultimate Unification of Gradient and Mirror Descent}. From the lemma, our analysis of the runtime of the algorithm naturally follows.
...
\[\epsilon(t) = \cO \left (2^{-t\sqrt{\frac{\alpha}{\beta}}} \right).\]
...
\begin{table}[h]
  \begin{center}
    \begin{tabular}{ | p{2cm} | c | c |}
      ...
      & \begin{tabular}{c}
        $\cO \left(2^{-t\sqrt{\frac{\alpha}{\beta}}}\right)$
        \rule[0cm]{0cm}{1cm}
        \end{tabular} 
      & \begin{tabular}{c}
        $\cO \left(2^{-t\frac{\alpha}{\beta}} \right)$
        \rule[0cm]{0cm}{1cm}
        \end{tabular} \\ \hline
    \end{tabular}
  \end{center}
