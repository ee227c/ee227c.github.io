...
\begin{theorem}[Projected Gradient Descent for Lipchitz Functions]
...
\begin{itemize}
    ...
    \item $\lVert \Pi_\domain (y) - x \rVert^2 \leq \lVert y - x \rVert^2 - \lVert y - \Pi_\domain (x) \rVert^2$ % From above TODO
\end{itemize}
